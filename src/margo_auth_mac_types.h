#ifndef MARGO_AUTH_MAC_TYPES_H
#define MARGO_AUTH_MAC_TYPES_H
...
static inline void create_token(token_t* token, uid_t uid, uint64_t seq_no, const char* key, size_t key_len) {
